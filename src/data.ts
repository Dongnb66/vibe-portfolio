...
export const profile = {
  ...
  intro: [
    ...
    '测试基线：<strong>6 个仓库共 515 条单测/冒烟断言</strong>（零 API Key 可跑）+ <strong>9 条防幻觉评测用例（6 常规 + 3 对抗）</strong>，常规集挂入 GitHub Actions CI。',
...
export const stats = [
  ...
  { num: '515', label: 'Tests', sub: '6 仓库 · 零 Key 可跑 · CI 持续通过' },
...
export const projects = [
  {
    ...
    highlights: [
      ...
      '完整 Dockerfile + docker-compose + pytest 153 passed + .env.example',
    ],
...
export const skills = [
  ...
  },
  {
    ...
    list: ['RAG', 'BM25 稀疏检索', '混合检索 + RRF 融合', '相关性阈值拒答'],
  },
  {
    icon: '☕',
    name: 'Java / Spring Boot 后端',
    desc: 'Spring Boot 3 + Java 21 智能体平台后端项目实证，core 层纯 Java 可独立测试',
    list: ['Spring Boot 3', 'Java 21', 'JPA(H2/MySQL)', 'JUnit', 'REST API'],
  },
  {
    icon: '🛡️',
    name: '账号 / 鉴权体系',
  ...
  },
  {
    ...
    list: ['腾讯云 TC3-HMAC-SHA256', 'SMTP', '验证码限流', '企业微信推送'],
  },
  {
    icon: '⚙️',
    name: '后端工程化',
    desc: 'FastAPI / Express / Spring Boot 分层，配置、中间件、错误处理齐全',
    list: ['FastAPI', 'Express', 'Spring Boot', 'SQLAlchemy', 'node:sqlite'],
  },
  {
    icon: '🧪',
    name: '测试驱动交付',
    desc: '端到端管线 + 官方签名测试向量 + 跨会话记忆，交付前可自动验证',
    list: ['pytest', 'vitest', 'node --test', 'JUnit', '防幻觉评测集', '515 条测试与断言'],
  },
  {
    icon: '🚀',
    name: '容器化部署',
  ...
  },
  {
    ...
    list: ['工具调用', '百度地图 API', '轮数上限收敛', '结果回填'],
  },
  {
    icon: '🧩',
    name: 'MCP 协议开发',
